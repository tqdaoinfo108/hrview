      ...
      <EmptyLayout.Section center>
        ...
        <Form className="mb-3">
          <FormGroup>
            ...
            <Input type="email" value={userName} name="userName" id="emailAdress"
                   onChange={(e) => setUserName(e.target.value)} placeholder="Enter email..." className="bg-white"/>
          ...
          <FormGroup>
            ...
            <Input type="password" value={passWord} name="passWord" id="password"
                   onChange={(e) => setPassWord(e.target.value)} placeholder="Password..." className="bg-white"/>
          </FormGroup>
          <FormGroup>
